...
import hook check_queue_restricted_parameters application/x-python default /apps/soca/<CLUSTER_ID>/cluster_hooks/queuejob/check_queue_restricted_parameters.py
